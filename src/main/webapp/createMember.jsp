...
<head>
    ...
    <title>Add Member - SportFlow</title>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<%=request.getContextPath()%>/member" method="post">
                        ...
                        <div class="mb-3">
                            <label for="sportPracticed" class="form-label">Sport Practiced</label>
                            <input type="text" class="form-control" id="sportPracticed" name="sportPracticed" required>
                        </div>
                        <div class="mb-3">
